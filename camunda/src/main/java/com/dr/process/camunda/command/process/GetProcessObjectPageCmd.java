 ...
 * @author dr
 */
public class GetProcessObjectPageCmd extends AbstractGetProcessObjectCmd implements Command<Page<ProcessObject>> {
    private int start;
    private int end;

    public GetProcessObjectPageCmd(ProcessQuery query, int start, int end) {
        super(query);
        this.start = start;
        this.end = end;
    }
