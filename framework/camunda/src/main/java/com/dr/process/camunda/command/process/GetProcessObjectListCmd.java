 ...
 * @author dr
 */
public class GetProcessObjectListCmd extends AbstractGetProcessObjectCmd implements Command<List<ProcessObject>> {

    public GetProcessObjectListCmd(ProcessQuery query) {
        super(query);
    }
